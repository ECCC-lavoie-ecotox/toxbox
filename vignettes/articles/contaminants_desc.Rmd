---
title: "Statistiques descriptives sur les contaminants"
...
# Cartographie des tailles d'échantillon

## Objectifs

1. Otenir une liste exhaustive des contaminants mesurés chez trois espèces impliquées dans le PASL.
   a. Regrouper ces contaminants en famille 
2. Produire une cartographie des tailles d'échantillons pour les combinaisons: Site, espèce, années, contaminant
...
```{R}
contaminants |> 
    dplyr::group_by(source, conpound_family, variable) |>
...
## Objectif 2: Produire une cartographie des tailles d'échantillons pour les combinaisons: Site, espèce, années, contaminant

### Nombre de mesures par année, site, espèce, contaminant

```{R, results = "asis"}
contaminants |> 
    dplyr::group_by(Location, Year, Species, variable) |>
